...
public class equipmentServiceImpl implements equipmentService {
	...
	public void addEqexamine(Eqexamine eqexamine) {
		...
		//修改报废表（如果有损坏、丢失）
		equipmentMapper.deleteEquipment(eqexamine.getEq_id(), eqexamine.getEq_num_damage()+eqexamine.getEq_num_lose());
		//计算是否逾期
		...
		equipmentMapper.updateEqCount(eqexamine.getEq_id(),-(eq_count-eqexamine.getEq_num_damage()-eqexamine.getEq_num_lose()));
		//计算罚款
		Equipmentspend equipmentspend = equipmentMapper.selectEqspendByPrimaryKey(eqexamine.getEq_id());
		float eq_publish=eqexamine.getEq_num_damage()*equipmentspend.getEq_damage()+eqexamine.getEq_num_lose()*equipmentspend.getEq_lose();
