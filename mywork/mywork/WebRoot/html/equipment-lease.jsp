			...
			<ul class="nav nav-tabs">
				...
				<li class="dropdown pull-right">
					...
					<ul class="dropdown-menu">
						...
						<input type="hidden" id="hid-charge" value="${eq_price }" > 
						<input type="hidden" id="hid-depoist" value="${eq_deposit }" > 
	<div class="col-md-2 column div-block"></div>
		<div class="col-md-8 column div-block" style="margin-top:35px;">
		<form class="form-horizontal" action="${pageContext.request.contextPath }/submitLease.action" method="get" role="form">
				<div class="form-group">
					 <label for="inputEmail3" class="col-sm-2 control-label">用户名</label>
					<div class="col-sm-10">
						<input type="text"  readonly = "readonly" class="form-control" value="<%= session.getAttribute("username")%>" />
						<input type="hidden" name="eq_user_id" value="<%= session.getAttribute("userid")%>"/>
					</div>
				</div>
				<div class="form-group">
					 <label for="inputPassword6" class="col-sm-2 control-label">器材编号</label>
					<div class="col-sm-10">
						<input type="text"  readonly = "readonly" name="eq_id" class="form-control" id="inputPassword6" value="${id }"/>
					</div>
				</div>
				<div class="form-group">
				    <label class="col-sm-2 control-label">开始日期:</label>
					<div class="col-sm-10">
						<input class="form-control" readonly = "readonly"  type="text" name="eq_date_rental" id="startDate2">
					</div>
				</div>
				<div class="form-group">
				    <label class="col-sm-2 control-label">结束日期:</label>
					<div class="col-sm-10">
						<input class="form-control" readonly = "readonly"  name="eq_date_return" type="text" value="" id="endDate2">
					</div>
				</div>
				<div class="form-group">
				    <label class="col-sm-2 control-label">数量:</label>
					<div class="input-group col-sm-10 spinner" style="width: 100px;padding-left:15px;" data-trigger="spinner" id="spinner"> 
					<input type="text" readonly = "readonly" class="form-control" name="eq_count" id="count" value="1" data-max="${count }" data-min="1" data-step="1"> 
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" readonly = "readonly" name="eq_charge" class="form-control" id="charge" value="" />
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						 <button type="submit" class="btn btn-success" >提交</button>
						 <button type="button" onclick="window.location.href='${pageContext.request.contextPath }/toQueryPage.action'" class="btn btn-success">返回</button>
					</div>
				</div>
			</form>
		</div>
